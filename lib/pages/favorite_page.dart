...
class _FavoritePageState extends State<FavoritePage> {
  ...
  _generatePDF() async {
    ByteData bytesx = await rootBundle.load("assets/image/grecia.jpg");
...
//   _generatePDF() async {
//     ByteData bytesx = await rootBundle.load("assets/image/image1.jpeg");
//     Uint8List imageBytes = bytesx.buffer.asUint8List();
...
//             //return pw.Text("Jean Carlos Bartra Lujan");
//           }),
//     );
